...
namespace projeto_final.Controllers
{
    public class SaidaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SaidaProdutoData,SaidaProdutoQuantidade,ProdutoId,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SaidaProdutoData,SaidaProdutoQuantidade,ProdutoId,UsuarioId,ClienteId,TipoSaidaId")] SaidaProduto saidaProduto)
        {
