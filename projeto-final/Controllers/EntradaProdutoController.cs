...
namespace projeto_final.Controllers
{
    public class EntradaProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,EntradaProdutoQuantidade,EntradaProdutoData,ProdutoId")] EntradaProduto entradaProduto)
        {
            if (ModelState.IsValid)
            {
                var produto = await _context.Produto.Where(p => p.Id == entradaProduto.ProdutoId).FirstOrDefaultAsync();
                produto.ProdutoEstoque = produto.ProdutoEstoque + entradaProduto.EntradaProdutoQuantidade;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,EntradaProdutoQuantidade,EntradaProdutoData,ProdutoId")] EntradaProduto entradaProduto)
        {
